...
class Label_Tab():
    ...
    def setup_connection(self):
        # dropdown
        self.parent.Label_Filename_ComboBox.activated.connect(self.filename_combobox_change)
        self.parent.Label_Ant_ComboBox.activated.connect(self.setup_ant_plot)
        ...
        # self.parent.LabelLoadTotPlot.clicked.connect(self.load_total_plot_clicked)
        # slider
    ...
    def add_behavior(self):
        ...
        if self.cur_folder_key is None or folder_key == "":
            ...
            # update other tabs
            self.parent.BehaviorsTab.setup()
